        ...
        <div class="card-body">
         ...
         <form action="/item/{{$item->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                 ...
                 <input type="text" class="form-control" name="quantity" value="{{ old('quantity',$item->quantity) }}">
            </div>
            <div class="form-group">
                 <label for="">Original_price</label>
                 <input type="text" class="form-control" name="original_price" value="{{ old('original_price',$item->original_price) }}">
            </div>
            <div class="form-group">
                 <label for="">Selling_price</label>
                 <input type="text" class="form-control" name="selling_price" value="{{ old('selling_price',$item->selling_price) }}">
            </div>
            ...
            <div class="form-group">
                 ...
                 <img src="{{url('/images/'.$item->image)}}" width=100 height=100></br></br>
